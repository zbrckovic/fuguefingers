...
export const KEY_DEAD_ZONE = 5
export const WHITE_KEY_VELOCITY_SENSITIVE_PART_HEIGHT = WHITE_KEY_HEIGHT - 2 * KEY_DEAD_ZONE
export const BLACK_KEY_VELOCITY_SENSITIVE_PART_HEIGHT = BLACK_KEY_HEIGHT - 2 * KEY_DEAD_ZONE
